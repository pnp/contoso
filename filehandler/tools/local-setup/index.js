...
function Setup(workingDir) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var secretsDir, token, _a, appId, appSecret, created, id;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    _a = _b.sent(), appId = _a.appId, appSecret = _a.appSecret, created = _a.created, id = _a.id;
                ...
                case 3:
                    ...
                    tasks_1.WriteLocalSettings(secretsDir, appId, appSecret);
                    _b.label = 4;
                case 4:
