...
var GetToken = function () { return __awaiter(void 0, void 0, void 0, function () {
    var readline, appId, tenantId, token, pca, tokenResponse;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                logger_1.enter("GetToken");
                logger_1.log("Beginning device-code flow.");
                readline = readline_1.createInterface({
                    input: process.stdin,
                    output: process.stdout,
                });
                return [4 /*yield*/, new Promise(function (resolve) {
                        readline.question("What is the client id for the setup application? ", function (id) {
                            resolve(id);
                        });
                    })];
            case 1:
                appId = _a.sent();
                return [4 /*yield*/, new Promise(function (resolve) {
                        readline.question("What is the tenant id for the setup application? ", function (id) {
                            resolve(id);
                        });
                    })];
            case 2:
